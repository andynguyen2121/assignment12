...
int binarySearch(int arr[], int size, int target)
{
    ...
    @andynguyen2121 ➜ /workspaces/assignment12 (main) $ g++ -Wall -Wextra -std=c++17 -o ch18 ch18_nguyen.cpp 
    @andynguyen2121 ➜ /workspaces/assignment12 (main) $ ./ch18 
    === Chapter 18: Searching and Sorting ===

    --- Linear Search ---
    Array: 64 25 12 78 33 90 47 5 61 18 
    Found 78 at index 3
    99 not found.

    --- Bubble Sort ---
    Before: 64 25 12 78 33 90 47 5 61 18 
    After:  5 12 18 25 33 47 61 64 78 90 
    ...
    --- Quick Sort (scaffolded) ---
    Before: 64 25 12 78 33 90 47 5 61 18 
    After:  5 12 18 25 33 47 61 64 78 90 

    --- Merge Sort (scaffolded) ---
    Before: 64 25 12 78 33 90 47 5 61 18 
    After:  5 12 18 25 33 47 61 64 78 90 

    --- Binary Search ---
    Sorted array: 5 12 18 25 33 47 61 64 78 90 
    Found 47 at index 5
    99 not found.

    @andynguyen2121 ➜ /workspaces/assignment12 (main) $ 
